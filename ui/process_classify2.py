...
def one_llm_classify_relevance(text_content):
    ...
    Please review the user's paper and return - on a scale of 1-10 
    whether the paper is about experimental study of mycoremediation.
    
    Score should be 1 if the paper is not relevant at all.
    
    Score should be 10 if the paper focuses on direct experiments involving 
    fungal species for bioremediation, particularly examining the ability of 
    specific fungi to degrade or decolorize dyes or pollutants. 
    Also give high score to studies that investigate the activity or role of 
    enzymes such as laccase, lignin peroxidase, or manganese peroxidase in the 
    fungal degradation or bioremediation process.
...
if st.button("Process files : Stage 2"):
